                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        child: Column(
                          children: [
                            Navbar_Item(context, Icons.person_outline_sharp,
                                "Edit Profile", () {
                              log("Profileeee");
                            }),
                            const Divider(
                            ...
                            Navbar_Item(context, Icons.shopping_cart_outlined,
                                "Order History", () {
                              log("Order");
                            }),
                            const Divider(
                            ...
                            Navbar_Item(context, Icons.local_offer_outlined,
                                "Discount And Promo", () {
                              log("PROMOOOOO");
                            }),
                            const Divider(
                            ...
                            Navbar_Item(context, Icons.privacy_tip_outlined,
                                "Privacy Policy", () {
                              log("Privacy Policy");
                            }),
                            const Divider(
                            ...
                            Navbar_Item(
                                context, Icons.sticky_note_2_outlined, "About",
                                () {
                              log("About");
                            }),
                            SizedBox(
                            ...
                            Navbar_Item(
                                context, Icons.arrow_back_sharp, "Signout",
                                () async {
